...
void print_entyr(unsigned long int e_entry, unsigned char *e_identity);
 ...
 * @e_entry: The address of entry
 * @e_identity: A pointer
 */
void print_entry(unsigned long int e_entry, unsigned char *e_identity)
{
